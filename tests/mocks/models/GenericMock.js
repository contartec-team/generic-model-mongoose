...
class GenericMock {
  ...
  */
  static async addList(params, length = 3) {
  ...
  /**
   * Inserts the `mocks` (use [`addList`]{@link GenericMock.addList} instead)
   * @deprecated **use [`addList`]{@link GenericMock.addList} instead**
   *
   * @param {Array<Generic> | Object} params The object `params` to set in every mock or a list of `mocks`
   * @param {Number} [length = 3] The number of `mocks` to be created
   *
   * @return {Promise<Array>} The list of created `mocks`
  */
  static addMocks(params, length = 3) {
    return this.addList(params, length)
  }
